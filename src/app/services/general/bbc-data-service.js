...
var BBCDataService = (function () {
    ...
    BBCDataService.prototype.extractData = function (res) {
        ...
        for (var _i = 0, articles_1 = articles; _i < articles_1.length; _i++) {
            ...
            newsArray.push(new news_1.News(news.author, news.title, news.description, news.url, news.urlToImage, news.publishedAt, 'BBC News'));
        }
        return newsArray || {};
    };
    /**
...
//# sourceMappingURL=bbc-data-service.js.map